...
function test_docker_image() {
  local apps="stress-tester k8s-api-test receiver-mock check delete-excessive-pvc fix-log-symlinks tools-usage template template-dependency template-prometheus-mixin"
